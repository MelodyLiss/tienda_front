...
export const NavBar = () => {
    return (
        <nav className="nav_cinta bg-orange-500 w-full lg:w-7xl mx-auto mt-4">
            <ul className="flex flex-wrap justify-around items-center font-medium text-amber-50 text-sm sm:text-xl">
